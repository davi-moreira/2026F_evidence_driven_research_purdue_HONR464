...
- **Other material:** nb00 (Colab); course website; syllabus; Brightspace orientation; genai.rcac.purdue.edu login
...
- **Hands-on activity:** Open nb00 in Colab, save a copy to Drive, ask Gemini for sources on a shared question, and catch the one citation that will not resolve using the verification checklist.
...
- **Milestone developed:** M0 — Research and AI baseline (kickoff)
...
- **Student artifact:** Executed nb00 readiness cells + first AI Research Ledger entry (the caught citation)
...
- **Instructor prep:** Verify nb00 loads in Colab from the public repo; rehearse the live Gemini citation-catch and keep an offline screenshot backup; confirm GenAI Studio logins work; roster the 5 students.
- **Risks / contingency:** Gemini returns only valid citations in the live demo → fall back to the saved transcript of a prior hallucination and have the class verify it; account/Colab issues → pair on one laptop and finish readiness at home.
...
- **Other material:** nb00 §Lecture 2 (Colab); the AI Research Ledger template
...
- **Hands-on activity:** Run one toy claim through all seven SDIIVDD moves in nb00 and fill a complete AI Research Ledger row, ending with a source you personally opened.
...
- **Milestone developed:** M0 — Research and AI baseline (dev)
...
- **Instructor prep:** Prepare the toy-claim cycle end-to-end in nb00; print the SDIIVDD and never-delegate cards; review any early M0 drafts.
...
- **Other material:** nb00 student notebook (research in the age of AI) — recap reference (Colab); M1 Brightspace brief
...
- **Milestone work time:** 23 min studio block
...
- **Instructor prep:** Queue the stand-up and pitch order; M1 Brightspace brief on screen; warm-feedback + red-team norms posted; consult rotation list.
...
- **Student Research Lead slot:** SRL slot 01 — rotation seat A
...
- **Other material:** nb01 §Lecture 1 (Colab)
...
- **50-minute dynamic:** 0–9 SRL-led research puzzle: two students' broad interests side by side, only one already a research problem — the class names what the second added; 9–31 guided Gemini research-partner investigation in nb01: run your curiosity down the funnel, asking Gemini to surface candidate units, populations, and outcomes, then verify each suggestion against a real source; 31–43 human verification + instructor formalization: the instructor formalizes topic vs problem vs question and the importance/feasibility/contribution test, and the class corrects one over-eager AI suggestion; 43–50 decision & defense: log the funnel decisions in the Ledger + Claim Ticket.
- **Hands-on activity:** Run your curiosity through the nb01 funnel to a candidate problem, using Gemini to propose units, populations, and outcomes and verifying each before you keep it.
...
- **Milestone developed:** M1 — Research opportunity landscape (dev)
...
- **Student artifact:** Own curiosity funneled to a candidate problem with units, population, and outcome named in nb01
...
- **Instructor prep:** Brief SRL seat A on the two-interest puzzle; queue the worked funnel example; verify nb01 loads in Colab; review M0 submissions.
...
- **Student Research Lead slot:** SRL slot 02 — rotation seat B
...
- **Other material:** nb01 §Lecture 2 (Colab)
...
- **Hands-on activity:** Classify a deck of question cards by kind and reach, pit your classification against Gemini's, and resolve every disagreement with the definitions — then place your own question.
...
- **Milestone developed:** M1 — Research opportunity landscape (dev; compass position added)
...
- **Student artifact:** A classified question deck + own question placed on the compass in nb01
...
- **Other material:** nb01 student notebook (curiosity -> problem) — recap reference (Colab); M2 Brightspace brief
...
- **Instructor prep:** Queue stand-up + pitch order; M2 Brightspace brief on screen; red-team norms posted; consult rotation.
...
- **Student Research Lead slot:** SRL slot 03 — rotation seat C
...
- **Other material:** nb02 (Colab); Purdue Libraries database portal; Google Scholar
...
- **Hands-on activity:** Run paired Gemini and library-database searches for your own question, verify every source you keep is real and retrievable, log its central claim, and place a provisional gap on your evidence map.
...
- **Milestone developed:** M2 — Verified evidence and contribution map (dev)
...
- **Student artifact:** A source log with ≥2 verified entries + a started evidence map with a provisional gap in nb02
...
- **Risks / contingency:** Library portal outage → Google Scholar and open-access fallbacks are pre-listed in nb02; thin in-class results → snowball from one seed source and finish the map as homework.
...
- **Other material:** nb02 student notebook (research builds on research) — recap reference (Colab); M3 Brightspace brief
...
- **Student Research Lead slot:** SRL slot 04 — rotation seat D
...
- **Other material:** nb03 §Lecture 1 (Colab); make_dag DAG helper
...
- **Hands-on activity:** Draw your project's 3-node DAG and write your inquiry in one sentence, using Gemini to propose a lurking variable and an estimand phrasing that you then verify against your own model.
...
- **Milestone developed:** M3 — Research charter and MIDA declaration (dev)
...
- **Student artifact:** Own-project 3-node DAG + one-sentence inquiry in nb03
...
- **Student Research Lead slot:** SRL slot 05 — rotation seat E
...
- **Other material:** nb03 §Lecture 2 (Colab)
...
- **Hands-on activity:** Declare a simple design, simulate it to read its bias, variance, and power, then use Gemini to list threats to validity and verify each against what the simulation actually shows.
...
- **Milestone developed:** M3 — Research charter and MIDA declaration (dev; diagnosis + redesign added)
...
- **Student artifact:** Executed diagnosis simulation + own design's threats-to-validity note + one named redesign in nb03
...
- **Homework / next milestone:** Finalize and rehearse the M3 research charter + MIDA declaration for this Friday's studio (world, DAG, inquiry, data + answer strategy, diagnosis, redesign); finish nb03 cells.
...
- **Other material:** nb03 student notebook (anatomy of a research design) — recap reference (Colab); M4 Brightspace brief
...
- **Hands-on activity:** Deliver your 3-minute MIDA declaration, collect one clarifying question per listener, and use Gemini to test whether any two of your MIDA parts disagree.
...
- **Student prep:** 3-minute M3 declaration rehearsed; nb03 cells complete; laptop ready.
...
- **Student Research Lead slot:** SRL slot 06 — rotation seat A
...
- **Other material:** nb04 student notebook (observational descriptive), §1–3 (Colab); la_voter_file attribution note
...
- **Hands-on activity:** With Gemini as research partner, use la_voter_file as a sampling frame, draw repeated seeded samples, and state for each the population it can honestly describe and the gap the frame leaves out.
...
- **Homework / next milestone:** Finish nb04 §1–3 and keep building the M4 audit. For Wednesday, read the RDSS ch. 15 measurement and nonresponse sections.
...
- **Risks / contingency:** Voter file slow to load in Colab → nb04 subsamples on load (seeded) with the full-file path documented; the DAG discussion runs long → the measurement preview moves to Lecture 2.
...
- **Student Research Lead slot:** SRL slot 07 — rotation seat B
...
- **Other material:** nb04 student notebook (observational descriptive), §4–6 (Colab); lapop_brazil attribution + resample-caveat note
...
- **Risks / contingency:** Two explorations crowd the lab → the index build ships as a provided cell and the nonresponse reveal stays live; load fails → nb04's embedded 500-row fallback carries the class.
...
- **Other material:** nb04 (observational descriptive) for the recap; M5 Brightspace brief (causal identification strategy or causal-language boundary)
...
- **Milestone presentation/review:** M4 presented: 3-minute walkthrough + written two-line peer reviews + Gemini overclaim-check
- **Student prep:** M4 audit complete; 3-minute walkthrough rehearsed; nb04 finished.
...
- **Instructor prep:** Print two-line review slips; stage the M5 Brightspace brief; timer; consult order; confirm the Gemini overclaim-check prompt is ready.
- **Risks / contingency:** Walkthroughs overrun → peer reviews go silent-written and the M5 kickoff moves to homework with the brief posted.
...
- **Student Research Lead slot:** SRL slot 08 — rotation seat C
...
- **Other material:** nb05 student notebook (observational causal), §1–3 (Colab); cliningsmith_etal attribution note
...
- **Risks / contingency:** networkx DAG plotting fails in Colab → nb05 ships the DAGs as static images with the code shown but not required; the simulation runs long → the hidden-confounder reveal is pre-computed.
...
- **Student Research Lead slot:** SRL slot 09 — rotation seat D
...
- **Other material:** nb05 student notebook (observational causal), §4–6 (Colab); cliningsmith_etal attribution note
...
- **Homework / next milestone:** This Friday runs asynchronously online: complete nb05, run the required GenAI Studio 'Causal Identification Skeptic' review, and submit M5 by the posted time. Budget about 50 minutes.
...
- **Risks / contingency:** Intuition pictures crowd the lab → the DiD/RDD/IV block compresses to the three figures and nb05 carries the depth; content overruns → the identification paragraph moves into the async studio.
...
- **Calling Bullshit (optional):** optional: one callingbullshit.org case of your choice from the module linked in nb05
- **Other material:** nb05 — fully self-contained async module (Colab); GenAI Studio 'Causal Identification Skeptic' role; M6 Brightspace brief (posted today)
...
- **Dataset / simulation:** student's own project data plans + the nb05 lottery example for reference
...
- **Student prep:** nb05 lectures complete; identification paragraph (or causal-language boundary) drafted; GenAI Studio account access confirmed.
- **Student artifact:** Completed nb05 async module: recompute cell + skeptic-review log + red-team exchange + submitted M5 + board stand-up
...
- **Homework / next milestone:** Submit M5 and the nb05 module by the posted time. For Monday, read the RDSS ch. 17 opener on experimental descriptive designs; the M6 brief is on Brightspace.
- **Instructor prep:** Final-check nb05 runs unattended end-to-end; confirm the GenAI Studio 'Causal Identification Skeptic' role is live with its instructions in the module; post the M6 brief; seed and monitor the discussion board while traveling.
- **Risks / contingency:** A student is stuck alone → nb05 embeds hints behind expandable cells and an office-hours booking link; GenAI Studio unavailable → a provided Gemini fallback skeptic prompt stands in and the required review is logged when the service returns; the board is monitored remotely through the day.
...
- **Student Research Lead slot:** SRL slot 10 — rotation seat E
...
- **Other material:** nb06 student notebook (experimental descriptive), §1–3 (Colab); bonilla_tillery attribution note
...
- **Dataset / simulation:** bonilla_tillery.csv (survey experiment, treatment Z) analyzed as a measurement instrument + a seeded list-experiment simulation (seed 464)
- **50-minute dynamic:** 0–9 SRL-led research puzzle: the SRL presents a résumé-name audit study and asks why, though assignment is random, the inquiry is descriptive rather than causal; 9–31 guided Gemini research-partner investigation in the notebook: with Gemini as research partner, analyze the real survey experiment as a measurement of a latent attitude, then simulate a list experiment and ask Gemini to state what construct each design measures and what threatens its validity, checking against the data; 31–43 human verification + instructor formalization: the instructor formalizes experiments-as-measurement, latent characteristics, audit and list experiments, and the assignment-is-not-a-causal-inquiry point, and the class verifies Gemini's construct claims; 43–50 decision & defense: log the ledger entry and write the Claim Ticket.
- **Hands-on activity:** Analyze a real survey experiment as a measurement instrument and simulate a list experiment, naming the latent characteristic each estimates and the validity threat each faces.
...
- **Student artifact:** Analyzed survey experiment + list-experiment simulation + your project's measurement-experiment note
...
- **Instructor prep:** Confirm bonilla_tillery.csv loads; pre-seed the list-experiment simulation (seed 464); prepare the audit-study example; brief the SRL on the résumé-name puzzle.
- **Risks / contingency:** Survey-experiment analysis confuses → nb06 wraps the estimate in a helper that prints only the measured quantity and its uncertainty; time short → the list-experiment simulation moves to homework.
...
- **Student Research Lead slot:** SRL slot 11 — rotation seat A
...
- **Other material:** nb06 student notebook (experimental descriptive), §4–6 (Colab); bonilla_tillery attribution note
...
- **Risks / contingency:** Simulation too abstract → anchor every term to a cell and use the calibration example as the running case; time short → the redesign step ships as a provided comparison and the protocol drafting moves to homework.
...
- **Other material:** nb06 (experimental descriptive) for the recap; URC abstract template + internal-gate checklist; M7 Brightspace brief (declared analysis protocol); URC Expo abstract specs
...
- **Milestone presentation/review:** M6 presented: protocol clinic + partner abstract swap with the uncertainty-and-reach checklist + Gemini overbelief-check
- **Student prep:** M6 protocol complete; URC abstract drafted (150–250 words); nb06 finished.
...
- **Risks / contingency:** External URC portal shifts → the internal gate stands; abstracts go to Brightspace and are forwarded when the portal opens; the clinic overruns → the M7 kickoff brief is posted and read as homework.

## Week 8 — Prediction

### M21 — Wed 2026-10-14 (in-person) — Prediction: beat an honest baseline on unseen cases, and know when the win is fake

- **Student Research Lead slot:** SRL slot 12 — rotation seat B
...
- **Other material:** nb07 student notebook (prediction), §1–5 (Colab); scikit-learn (linked docs); the course-authored 'Observational: predictive' library entry
...
- **Hands-on activity:** Beat (or fail to beat) an honest baseline on held-out cases under cross-validation, catch a planted leak, and report leaky-vs-clean numbers with a calibration and subgroup check.
...
- **Homework / next milestone:** Finish nb07 and assemble the M7 declared analysis protocol for this Friday's studio, where it faces a prediction-and-leakage audit. No new reading.
...
- **Risks / contingency:** sklearn friction → all model code is provided and you choose the target column and read outputs; the leak found too fast → nb07's second, subtler temporal leak is the extension path.
...
- **Other material:** nb07 (prediction) for the recap; GenAI Studio 'Prediction & Leakage Auditor' role; M7 declared-analysis template; M8 Brightspace brief (minimum viable analysis)
...
- **Student prep:** Declared analysis protocol drafted; nb07 complete; GenAI Studio access confirmed.
...
- **Risks / contingency:** GenAI Studio unavailable → a provided Gemini fallback auditor prompt stands in and the required review is logged when the service returns; assembly overruns → the auditor review runs on the strongest protocols live and the rest asynchronously, with submission tonight.
...
- **Student Research Lead slot:** SRL slot 13 — rotation seat C
...
- **Other material:** nb08 student notebook (experimental causal research), §1–3 (Colab); Gemini in Colab as the in-class research partner
...
- **Homework / next milestone:** Finish nb08's potential-outcomes and power practice cells; Wednesday we take on what breaks a clean experiment — attrition, noncompliance, spillovers — and keep building M8.
...
- **Student Research Lead slot:** SRL slot 14 — rotation seat D
...
- **Other material:** nb08 student notebook (experimental causal research), §4–6 (Colab); Gemini in Colab as the applied-lab partner
...
- **Risks / contingency:** The complication list overwhelms → the lab commits to attrition + spillover as the two everyone simulates; blocking, clustering, and factorial run as read-and-inspect demos, with nb08 carrying the depth.
...
- **Other material:** nb08 student notebook (experimental causal) for the recap; M9 Brightspace brief (poster draft 1 + research audit); project/poster/storyboard_protocol.md (headline-claim preview); 60-second pitch timer
...
- **Student Research Lead slot:** SRL slot 15 — rotation seat E
...
- **Other material:** nb09 student notebook (attack the analysis), §1–3 (Colab); Gemini in Colab as the robustness-lab partner; project/poster/redteam_review_protocol.md (the four-audit vocabulary, previewed)
...
- **Dataset / simulation:** each student's own M8 estimate rerun under alternative specifications + a shared demonstration dataset with one influential outlier
...
- **Hands-on activity:** Pre-list your robustness checks, then rerun your own estimate across alternative specifications, run placebo and influence tests, and report where the claim holds and where it moves.
...
- **Homework / next milestone:** Run the rest of your pre-listed checks in nb09; Wednesday you turn AI reviewers loose on your own analysis and compare what they catch.
- **Instructor prep:** Verify the robustness-grid and influence cells run fast; build the shared one-outlier dataset; brief the SRL on the fragile-specification puzzle.
- **Risks / contingency:** The specification grid balloons → students commit to three pre-listed checks maximum for class, the rest as homework; the pre-listing rule is the point, not the count.

### M27 — Wed 2026-10-28 (in-person) — Attack the analysis II: human versus AI reviewers, and adversarial review of your own work

- **Student Research Lead slot:** SRL slot 16 — rotation seat A
...
- **Other material:** nb09 student notebook (attack the analysis), §4–5 (Colab); Purdue GenAI Studio — the multi-model comparison + an adversarial-reviewer role (today's designated GenAI Studio touchpoint); AI Research Ledger template
...
- **Other material:** nb09 student notebook (attack the analysis) for the recap; M10 Brightspace brief (final poster lock); Purdue GenAI Studio — REQUIRED Poster Critic + Robustness & Sensitivity Reviewer roles, logged in the ledger; project/poster/redteam_review_protocol.md (four-audit slip); AI Research Ledger template
...
- **Student Research Lead slot:** SRL slot 17 — rotation seat B
...
- **Instructor prep:** Mount all five drafts for the walk; print the four-audit + accessibility slips; verify the Gemini skeptic-question prompts produce usable output; brief the SRL on the impression-vs-number puzzle.
...
- **Student Research Lead slot:** SRL slot 18 — rotation seat C
...
- **Instructor prep:** Assemble the three-lens question deck per project; timer; verify the Gemini hard-question prompts; brief the SRL on the two-kinds-of-question puzzle.
...
- **Student Research Lead slot:** SRL slot 19 — rotation seat D
...
- **Other material:** nb11 student notebook (poster delivery) §1–2 (Colab); project/conference/presentation_plan_protocol.md; M11 brief on Brightspace
...
- **Student Research Lead slot:** SRL slot 20 — rotation seat E
...
- **Other material:** nb11 student notebook (poster delivery) §3–4 (Colab); project/conference/uncertainty_limitations_protocol.md; project/conference/hard_questions_protocol.md; M11 brief on Brightspace
...
- **Other material:** nb11 student notebook (poster delivery) §5 symposium + visitor role cards (Colab); project/conference/dress_rehearsal_protocol.md (station-round format); M11 due tonight; M12 brief on Brightspace
...
- **Student Research Lead slot:** SRL slot 21 — rotation seat A
...
- **Other material:** nb12 student notebook (conference prep) §1 readiness audit + visitor role card (Colab); project/conference/dress_rehearsal_protocol.md; project/conference/conference_reflection_protocol.md (the capture method); audience-coding sheet; M12 brief on Brightspace
...
- **Other material:** nb12 student notebook (conference prep) §2–3 reflection tally (Colab); project/conference/conference_reflection_protocol.md; M12 due tonight; M13 brief + the anonymized replication packages on Brightspace
...
- **Other material:** nb13 student notebook — fully self-contained async module (Colab); project/final_dossier/reproducibility_audit_protocol.md; the assigned anonymized replication package; GenAI Studio 'Reproducibility Auditor' role (genai.rcac.purdue.edu); async discussion board; M13 due Sunday night; M14 brief posted on Brightspace
...
- **Student Research Lead slot:** SRL slot 22 — rotation seat B
...
- **Other material:** nb14 student notebook (poster to research note) §1–2 (Colab); project/final_dossier/research_brief_template.md (the compression cousin of the note); M14 brief on Brightspace
...
- **Student Research Lead slot:** SRL slot 23 — rotation seat C
...
- **Other material:** nb14 student notebook (poster to research note) §3–4 reproducibility capsule (Colab); project/final_dossier/reproducibility_audit_protocol.md (the capsule anatomy); the course AI-use ledger; M14 due Friday; M15 brief on Brightspace
...
- **Hands-on activity:** Use Gemini to critique your discussion section, keep only the edits that sharpen without inflating, and pass restart-and-run-all on your reproducibility capsule.
...
- **Other material:** nb14 student notebook (poster to research note) §5 table read (Colab); project/final_dossier/research_brief_template.md (the table-read margin-note procedure); M14 due tonight; M15 brief on Brightspace
...
- **Student Research Lead slot:** SRL slot 24 — rotation seat D
...
- **Other material:** nb15 student notebook (managing AI agents) §1–2 (Colab); GenAI Studio sequential-workflow roles (genai.rcac.purdue.edu, Colab API or UI); the course AI-use ledger; M15 brief on Brightspace
...
- **Student Research Lead slot:** SRL slot 25 — rotation seat E
...
- **Other material:** nb15 student notebook (managing AI agents) §3–4 (Colab); project/final_dossier/evidence_defense_protocol.md (defense format + cross-examination norms); the course AI-use ledger; the defense order (drawn at Friday's M15 kickoff); M15 due Friday
...
- **Other material:** nb15 student notebook (managing AI agents) §5 synthesis (Colab); project/final_dossier/evidence_defense_protocol.md (final defenses + the submission checklist); course-reflection survey; M15 due tonight
