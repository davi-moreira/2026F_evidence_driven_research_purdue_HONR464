...
|---|---|---|---|---|---|
| M00 | Kickoff: Curiosity Map + tool readiness | M1 | M2 (30-sec pitch) | Wed Aug 26 | M01 |
| M01 | Research Question Pitch (gap → problem → question + candidate approach) | M2–M5 | M6 (2-min pitch + approach vote) | Fri Sep 4 | M02, M03 |
| M02 | Literature & Claim Map (verified sources, citation integrity) | M7–M8 | M8 (gallery walk) | Fri Sep 11 | M03 |
| M03 | Model & Inquiry Declaration (DAG + estimand) | M9–M10 | M10 (3-min declaration) | Wed Sep 16 | M07 |
| M04 | Measurement & Operationalization Plan | M11–M14 | M14 (3-min walkthrough) | Fri Sep 25 | M05, M07 |
| M05 | Data Strategy + Feasibility & Ethics Checkpoint | M15–M17 | M18 (90-sec statement) | Wed Oct 7 | M07 |
| M06 | Answer Strategy Declaration | M18–M21 | M21 (clinic + consults) | Wed Oct 14 | M07 |
| M07 | URC Abstract **(gate Fri Oct 9)** + Full Design Declaration | M19–M22 | M20 (abstract workshop), M22 (assembly consults) | abstract **Fri Oct 9**; declaration **Fri Oct 16** | M08–M12 |
| M08 | Design Diagnosis & Redesign Memo | M23–M24 | M24 (60-sec redesign pitch) | Fri Oct 23 | M09 |
| M09 | Pilot Analysis — **branches by approach** | M25–M28 | M28 (4-min walkthrough) | Fri Oct 30 | M10–M12, M19 |
| M10 | Poster Storyboard | M29 | M29 (90-sec storyboard pitch) | Mon Nov 2 | M11 |
| M11 | Poster Draft + Red-Team Review | M30 | M30 (structured red-team) | Wed Nov 4 | M12 |
| M12 | Final Poster | M31 (production) | M31 (final-checklist consults) | **Fri Nov 6** | M13–M16 |
| M13 | Presentation Plan (1-min + 3-min scripts + walk map) | M32–M33 | M32 (partner delivery rounds) | Wed Nov 11 | M15, M16 |
| M14 | Uncertainty & Limitations Statement + Question Bank | M33–M34 | M34 (hot seat) | Fri Nov 13 | M15, M16 |
| M15 | Dress Rehearsal + Readiness Audit | M35 | M35 (full simulation) | Mon Nov 16 (in class) | M16 |
| M16 | **URC Expo Presentation** (required) | — | **Tue Nov 17, URC Expo** | event attendance + presentation | M17–M19 |
| M17 | Conference Reflection (coded audience data) | M36 | M36 (story round + pair analysis) | Wed Nov 18 | M18 |
| M18 | Feedback-to-Redesign Plan | M37 | M37 (2-min redesign declaration) | Fri Nov 20 | M19–M23 |
| M19 | Poster-to-Dossier Module (sensitivity + claim ledger) | M38 (async) | async board (fragile-row post + reply) | Mon Nov 30 | M20–M23 |
| M20 | Reproducibility Audit (partner-verified) | M39–M40 | M39/M40 (reproduction exchange + sign-off) | Wed Dec 2 | M23 |
| M21 | Research Brief (one page) | M40–M41 | M41 (table read) | Fri Dec 4 | M22, M23 |
| M22 | Evidence Defense (10-min defense + 5-min cross-examination) | M41 (prep) | **M42 (Dec 7) / M43 (Dec 9)** | performed in class | M23 |
| M23 | Final Research Dossier + Claim Ledger | M43 (checklist) | M44 (submission ceremony) | **Fri Dec 11** | — |
...
1. **Every milestone has ≥1 prior in-class development meeting** before its due
   date (M16 is the event itself; its development is M13–M15).
2. **Every milestone has a presentation/review activity** (formats vary — see
   `MILESTONE_PRESENTATION_MAP.md`; with 5 students, every student presents
   every time).
3. **Submission dates never precede development**, and no two written milestones
   are due on the same day.
4. **Poster work is NOT delayed to November:** the poster's inputs (abstract
...
5. **Post-conference work is substantive:** M17–M23 comprise sensitivity
