...
|---|---|---|---|---|---|---|
| 1 | "turn curiosity into credible, evidence-based insight" | the whole arc, opened M2–M3 | nb00, nb01 | RDSS ch. 1–2 | M01 → M23 (the full chain) | all components |
...
| 3 | "identify meaningful gaps in a chosen field" | M4 (gap typology), M8–M9 (literature) | nb01 §3, nb03 | RDSS ch. 3–4 | M02 (gap), M03 (claim map with placed gap) | milestone bucket (30%) |
| 4 | "translate a gap into a well-scoped research problem" | M4–M5 | nb01 §3–4 | RDSS ch. 4 | M02 | milestone bucket |
| 5 | "formulate answerable research questions" | M5 (answerability rubric) | nb01 §4 | RDSS ch. 4 | M02, refined through M04 | milestone bucket |
| 6 | "choose and justify an appropriate position on the inquiry compass … at a conceptual level" | M6–M7 (the skill), deep dives M16–M16, M20–M22, M25–M26, M27–M28 | nb02; nb06, nb10, nb12, nb13 | RDSS ch. 7, 15–18 | M04 (inquiry declaration), M10 (compass-branched pilot), the `INQUIRY_DECLARATION` template | milestone bucket + defense |
| 7 | "use computational tools and AI to locate sources" | M8 (AI-assisted search + hallucination catch) | nb03 | fresh + RDSS ch. 4 | M03 | milestone bucket + AI-ledger habit |
| 8 | "operationalize concepts" | M17–M15 (concept→construct→indicator) | nb05 | RDSS ch. 8 (measurement) | M05 | milestone bucket |
| 9 | "analyze evidence" | M16–M28 (description → generalization → prediction → causal; the pilot) | nb06–nb13 | RDSS ch. 8–11, 15–18 | M06–M10 | milestone bucket |
| 10 | "verify results" | every notebook's "After running, verify" blocks; M17 recompute; M39–M40 reproduction exchange | all; esp. nb08, nb18 | RDSS ch. 21–22 | M10 (verification log), M19 (sensitivity), M20 (reproducibility audit with partner sign-off) | dossier bucket (20%) + engagement |
| 11 | "document decisions responsibly" | decision logs + AI-use ledger, introduced M2, finalized M39 | nb00 (ledger start), nb18 | RDSS ch. 21 | every milestone carries a decision/disclosure block; M20, M23 | dossier bucket |
| 12 | "design and defend a rigorous research approach" | M22 (full declaration), M23–M24 (diagnose/redesign), M42–M43 (Evidence Defense) | nb10, nb11, nb19 | RDSS ch. 10–11 | M08, M09, M22 | defense component (5%) + milestone bucket |
| 13 | "interpret findings with appropriate uncertainty and limitations" | M20 (uncertainty), M21 (generalization), M33 (ULN move) | nb10, nb15 | RDSS ch. 9–10 | M16 (uncertainty & limitations statement), every results-bearing milestone | poster + dossier buckets |
| 14 | "communicate results … written" | M29–M31 (poster), M40–M41 (brief), dossier | nb14, nb18 | fresh | M13–M15, M21, M23 | poster bucket (20%) + dossier bucket |
| 15 | "communicate results … oral" | M32–M35 (pitches, ULN, hot seat, rehearsal), URC Nov 17, defenses Dec 7/9 | nb15, nb19 | fresh | M16–M16, M22 | poster bucket + defense component |
