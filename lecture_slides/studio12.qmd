...
## Managing Multiple AI Agents {background-color="#1a1a19" .divider}
...
## The slowest critic sets the schedule {.densest}
...
## Conflicting Agents and Human Escalation {background-color="#1a1a19" .divider}
...
## Two defensible definitions, two different numbers {.densest}
...
## Final Research and AI-Management Portfolio {background-color="#1a1a19" .divider}
...
## Run the trays and watch the spread the claim is built from {.denser}
...
## Milestone 12: Your release and next cycle {background-color="#1a1a19" .divider}
