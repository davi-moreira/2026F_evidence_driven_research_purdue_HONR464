...
## What you can defend when you leave {data-menu-title="Studio 8 · What you can defend when you leave"}
...
## The milestone ahead {data-menu-title="Studio 8 · The milestone ahead"}
...
## The lessons in this studio {data-menu-title="Studio 8 · The lessons in this studio"}
...
## Robustness and Sensitivity {background-color="#1a1a19" .divider data-menu-title="CHAPTER 24 — Robustness and Sensitivity"}
...
## The research decision {data-menu-title="Ch 24 · The research decision"}
...
## The words this chapter uses {data-menu-title="Ch 24 · The words this chapter uses"}
...
## A reviewer's first question is about the versions you did not show {data-menu-title="Ch 24 · A reviewer's first question is about the versions you did not show"}
...
## Without the list, a delicate truth and a lucky slice look identical {data-menu-title="Ch 24 · Without the list, a delicate truth and a lucky slice look identical"}
...
## Two named attacks, and people mix them up constantly {data-menu-title="Ch 24 · Two named attacks, and people mix them up constantly"}
...
## The headline estimate has four handles you can turn {data-menu-title="Ch 24 · The headline estimate has four handles you can turn"}
...
## Before a dot joins the curve it passes a three-part gate {data-menu-title="Ch 24 · Before a dot joins the curve it passes a three-part gate"}
...
## A curve that agrees cannot see the flaw every version shares {data-menu-title="Ch 24 · A curve that agrees cannot see the flaw every version shares"}
...
## The spread says what your choices did, not what chance could do {data-menu-title="Ch 24 · The spread says what your choices did, not what chance could do"}
...
## Twenty turns of the AI loop is twenty specifications {data-menu-title="Ch 24 · Twenty turns of the AI loop is twenty specifications"}
...
## A discount, and a twelve percent headline you attack before defending {data-menu-title="Ch 24 · A discount, and a twelve percent headline you attack before defending"}
...
## Four handles turned, and one comparison kept off the curve {data-menu-title="Ch 24 · Four handles turned, and one comparison kept off the curve"}
...
## One span per panel, never a span across them {data-menu-title="Ch 24 · One span per panel, never a span across them"}
...
## Three null checks get muddled, and each has its own procedure {data-menu-title="Ch 24 · Three null checks get muddled, and each has its own procedure"}
...
## Check that every row answers the same question before reading a number {data-menu-title="Ch 24 · Check that every row answers the same question before reading a number"}
...
## An AI failure case {data-menu-title="Ch 24 · An AI failure case"}
...
## How it failed {data-menu-title="Ch 24 · How it failed"}
...
## Do not delegate {data-menu-title="Ch 24 · Do not delegate"}
...
## It is your turn {data-menu-title="Ch 24 · It is your turn"}
...
## Diagnostics and Negative Tests {background-color="#1a1a19" .divider data-menu-title="CHAPTER 25 — Diagnostics and Negative Tests"}
...
## The research decision {data-menu-title="Ch 25 · The research decision"}
...
## A clear ring can mean your solvent is toxic {data-menu-title="Ch 25 · A clear ring can mean your solvent is toxic"}
...
## Your own pipeline can manufacture the result you are about to report {data-menu-title="Ch 25 · Your own pipeline can manufacture the result you are about to report"}
...
## A negative test aims your exact analysis at a guaranteed zero {data-menu-title="Ch 25 · A negative test aims your exact analysis at a guaranteed zero"}
...
## The true answer is zero; your reading almost never will be {data-menu-title="Ch 25 · The true answer is zero; your reading almost never will be"}
...
## Three conditions, or your control is not a test {data-menu-title="Ch 25 · Three conditions, or your control is not a test"}
...
## Three tests aim at zero, and the vehicle control matches your solvent {data-menu-title="Ch 25 · Three tests aim at zero, and the vehicle control matches your solvent"}
...
## Leave-one-out asks whether a single point carries your finding {data-menu-title="Ch 25 · Leave-one-out asks whether a single point carries your finding"}
...
## A clean pass lowers one worry, and never more than that {data-menu-title="Ch 25 · A clean pass lowers one worry, and never more than that"}
...
## A wide ring is tempting, so read the ethanol disk first {data-menu-title="Ch 25 · A wide ring is tempting, so read the ethanol disk first"}
...
## An assay that catches a strong antibiotic can still miss a small artifact {data-menu-title="Ch 25 · An assay that catches a strong antibiotic can still miss a small artifact"}
...
## Both controls get read before the extract's ring means anything {data-menu-title="Ch 25 · Both controls get read before the extract's ring means anything"}
...
## Build a world where the vehicle does nothing, then run it 2,000 times {data-menu-title="Ch 25 · Build a world where the vehicle does nothing, then run it 2,000 times"}
...
## In 2,000 honest experiments, not one reading was exactly zero {data-menu-title="Ch 25 · In 2,000 honest experiments, not one reading was exactly zero"}
...
![](figs/ch22_null_spread.png){fig-align="center" width="70%" fig-alt="Histogram of 2,000 measured vehicle effects in a world where the true effect is zero. The bars form a bell centered on zero, spanning roughly -0.4 to +0.4 millimetres, with a dashed line at zero and an orange line marking one experiment that read -0.03 millimetres."}
...
## The pile shows ordinary variation; it is never a pass line {data-menu-title="Ch 25 · The pile shows ordinary variation; it is never a pass line"}
...
## An AI failure case {data-menu-title="Ch 25 · An AI failure case"}
...
## How it failed {data-menu-title="Ch 25 · How it failed"}
...
## Do not delegate {data-menu-title="Ch 25 · Do not delegate"}
...
## It is your turn {data-menu-title="Ch 25 · It is your turn"}
...
## AI as Adversarial Reviewer {background-color="#1a1a19" .divider data-menu-title="CHAPTER 26 — AI as Adversarial Reviewer"}
...
## The research decision {data-menu-title="Ch 26 · The research decision"}
...
## The words this chapter uses {data-menu-title="Ch 26 · The words this chapter uses"}
...
## The person who signs off is the one fielding the complaints {data-menu-title="Ch 26 · The person who signs off is the one fielding the complaints"}
...
## "I trust the check, not the graph" {data-menu-title="Ch 26 · “I trust the check, not the graph”"}
...
## A confident number and a fluent critique fail the same way {data-menu-title="Ch 26 · A confident number and a fluent critique fail the same way"}
...
## A reviewer's job is to attack your result, not to praise it {data-menu-title="Ch 26 · A reviewer's job is to attack your result, not to praise it"}
...
## You measured at one time of day, so measure at two more {data-menu-title="Ch 26 · You measured at one time of day, so measure at two more"}
...
## Reporting only the hour where your change wins has a name {data-menu-title="Ch 26 · Reporting only the hour where your change wins has a name"}
...
## Two reviewers wrong the same way is an echo, not a confirmation {data-menu-title="Ch 26 · Two reviewers wrong the same way is an echo, not a confirmation"}
...
## An agentic reviewer finds more, and still does not get a vote {data-menu-title="Ch 26 · An agentic reviewer finds more, and still does not get a vote"}
...
## You attack the p95 drop from 210 to 137 before you defend it {data-menu-title="Ch 26 · You attack the p95 drop from 210 to 137 before you defend it"}
...
## Three reviewers, three fatal flaws, all confident and all different {data-menu-title="Ch 26 · Three reviewers, three fatal flaws, all confident and all different"}
...
## Turn each flaw into a check, and two of them dissolve {data-menu-title="Ch 26 · Turn each flaw into a check, and two of them dissolve"}
...
## Watch which line decides, not which reviewer sounded surest {data-menu-title="Ch 26 · Watch which line decides, not which reviewer sounded surest"}
...
## The flaw that survives is the one no measurement can remove {data-menu-title="Ch 26 · The flaw that survives is the one no measurement can remove"}
...
## An AI failure case {data-menu-title="Ch 26 · An AI failure case"}
...
## How it failed {data-menu-title="Ch 26 · How it failed"}
...
## Do not delegate {data-menu-title="Ch 26 · Do not delegate"}
...
## It is your turn {data-menu-title="Ch 26 · It is your turn"}
...
## Recognizing False Confidence {background-color="#1a1a19" .divider data-menu-title="CHAPTER 27 — Recognizing False Confidence"}
...
## The research decision {data-menu-title="Ch 27 · The research decision"}
...
## The words this chapter uses {data-menu-title="Ch 27 · The words this chapter uses"}
...
## The reviewer acts on the number, not on the sentence {data-menu-title="Ch 27 · The reviewer acts on the number, not on the sentence"}
...
## An AI partner writes you a sure-sounding finding in seconds {data-menu-title="Ch 27 · An AI partner writes you a sure-sounding finding in seconds"}
...
## "Cut nitrate by roughly 40 percent" feels settled before you look {data-menu-title="Ch 27 · “Cut nitrate by roughly 40 percent” feels settled before you look"}
...
## Two habits make the trap dangerous {data-menu-title="Ch 27 · Two habits make the trap dangerous"}
...
## A number wrong on turn one is usually still wrong on turn six {data-menu-title="Ch 27 · A number wrong on turn one is usually still wrong on turn six"}
...
## Verify the number, not the paragraph {data-menu-title="Ch 27 · Verify the number, not the paragraph"}
...
## Code that runs is not code that is correct {data-menu-title="Ch 27 · Code that runs is not code that is correct"}
...
## One small stream, a buffer planted last year, two years of readings {data-menu-title="Ch 27 · One small stream, a buffer planted last year, two years of readings"}
...
## Reaching to quote the clean result is where false confidence would win {data-menu-title="Ch 27 · Reaching to quote the clean result is where false confidence would win"}
...
## The real drop is 1.2 mg/L, about 15 percent, not 40 {data-menu-title="Ch 27 · The real drop is 1.2 mg/L, about 15 percent, not 40"}
...
## Even the true 15 percent cannot be pinned on the buffer alone {data-menu-title="Ch 27 · Even the true 15 percent cannot be pinned on the buffer alone"}
...
## Recomputing the drop takes about as long as reading the confident sentence {data-menu-title="Ch 27 · Recomputing the drop takes about as long as reading the confident sentence"}
...
## An AI failure case {data-menu-title="Ch 27 · An AI failure case"}
...
## How it failed {data-menu-title="Ch 27 · How it failed"}
...
## Do not delegate {data-menu-title="Ch 27 · Do not delegate"}
...
## It is your turn {data-menu-title="Ch 27 · It is your turn"}
...
## Milestone 8: Your robustness audit {background-color="#1a1a19" .divider data-menu-title="MILESTONE 8 — Milestone 8: Your robustness audit"}
...
## What this milestone produces {data-menu-title="M8 · What this milestone produces"}
...
## What you bring {data-menu-title="M8 · What you bring"}
...
## The practice {data-menu-title="M8 · The practice"}
...
## The four rails, here {data-menu-title="M8 · The four rails, here"}
...
## A version, not a pass {data-menu-title="M8 · A version, not a pass"}
