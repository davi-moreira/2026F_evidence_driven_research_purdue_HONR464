...
## Model, Inquiry, Data Strategy, and Answer Strategy {background-color="#1a1a19" .divider}
...
## Any research design can be written as four parts, and the four have names {.dense}
...
## The dashed arrow is the check that matters {.dense}
...
## Same model, same inquiry: watch the second number miss the truth {.densest}
...
## Uncertainty Before You Need It {background-color="#1a1a19" .divider}
...
## Watch two honest surveys disagree {.denser}
...
## Those three numbers are what uncertainty language exists to say
...
## The intervals caught the truth 94.8% of the time {.dense}
...
## Fixed numbers do not have chances
...
## The naive interval promised 95% and delivered 63.2% {.denser}
...
## Sixty flats in 12 buildings carry roughly the information of 14 independent flats
...
## Declaring and Diagnosing a Research Design {background-color="#1a1a19" .divider}
...
## The bias column and the power column answer different questions {.densest}
...
## Research Ethics and Data Governance {background-color="#1a1a19" .divider}
...
## Four ordinary columns, and two in three respondents are unique {.denser}
...
## The protection failed most for the least common characteristics {.dense}
...
## The fix is fewer columns, decided before collection
...
## Milestone 4: Your research contract, v0 {background-color="#1a1a19" .divider}
