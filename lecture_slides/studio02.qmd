...
## AI Is Your Arm, Not Your Brain {background-color="#1a1a19" .divider}
...
## The code takes the index on faith, exactly as the tool did {.denser}
...
## You as a Research Director {background-color="#1a1a19" .divider}
...
## Run it, change one input, and watch a sentence stop being true {.denser}
...
## Specify, Delegate, Interrogate, Inspect, Verify, Document, Defend {background-color="#1a1a19" .divider}
...
## SDIIVDD is Ask, Verify, Document opened up {.dense}
...
## Two rows, one log, and only one survives Verify {.denser}
...
## Defend states the result and what it does not establish
...
## Research Responsibility and Intellectual Ownership {background-color="#1a1a19" .divider}
...
## Run the one-minute check before you read the next line {.dense}
...
## You own the corrected sentence; you would not have owned the original
...
## Choose Your Question's Kind and Reach {background-color="#1a1a19" .divider}
...
## Run it, then break one sentence on purpose {.dense}
...
## Declare Your Research Question {background-color="#1a1a19" .divider}
...
## Same world, two sentences, two answers {.densest}
...
## The card records why wording A won
...
## Milestone 2: Your rules and your question {background-color="#1a1a19" .divider}
