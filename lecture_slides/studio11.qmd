...
## Replication and Reproduction {background-color="#1a1a19" .divider}
...
## A clean run proves the code executes, not that the write-up is true {.dense}
...
## Three defensible numbers, and none of them is 0.50 {.densest}
...
## Open and Reusable Research Packages {background-color="#1a1a19" .divider}
...
## Rerun the cell and the interval does not move {.densest}
...
## Milestone 11: Your reproducible package {background-color="#1a1a19" .divider}
