...
![](figs/sampling_groups.png){fig-align="center" width="52%" fig-alt="Diagram of overlapping regions. A large box is the target population; inside it, a shaded box is the accessible population. A dashed box, the sampling frame, starts inside those and extends out past the right edge of the target population. The sample is a solid box inside the frame. Three labels point into the picture: the part of the target never listed on the frame is undercoverage; the part of the frame outside the target is overcoverage; and two joined dots inside the frame are one unit listed twice, a duplicate."}
...
![](figs/ch11_sampling_channels.png){fig-align="center" width="58%" fig-alt="Dot plot. Ten blue random-sample means huddle between about 47 and 51 around a dashed line at the true mean of 49.1. A single orange convenience-channel mean sits alone at about 33."}
...
![](figs/ch14_overfitting.png){fig-align="center" width="72%" fig-alt="Two-panel chart. Left panel: a blue training-error line falling steadily across polynomial degrees 1 to 12, an orange selection-error line falling to degree six then climbing, a dotted vertical line at degree six labeled chosen on selection, and a black diamond labeled final holdout above the selection curve. Right panel: a histogram of the winner's true error minus its winning selection score across 500 simulated worlds, centered just right of zero, annotated mean optimism plus 0.025 RMSE, median plus 0.015, worse than its crowning score in 64 percent of worlds, with an arrow noting 4 worlds beyond plus 0.3 and the largest at plus 1.86."}
...
![](figs/ch15_randomization.png){fig-align="center" width="70%" fig-alt="Histogram of 2,000 estimated effects in blue, roughly bell-shaped from about 0 to 10 percentage points, with a dashed vertical line at the true effect of 5.0 and an annotation reading mean of estimates 5.0."}
...
![](figs/ch15_attrition.png){fig-align="center" width="70%" fig-alt="Histogram of 2,000 complete-case contrasts in orange, centered near 8.1 percentage points, with a dashed vertical line at the true effect of 5.0 sitting far to the left of the entire distribution."}
