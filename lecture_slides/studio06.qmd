...
## Data Provenance and Data Quality {background-color="#1a1a19" .divider}
...
## One numerator, three denominators, and the spread the label decides {.densest}
...
## Measurement and Operationalization {background-color="#1a1a19" .divider}
...
## Watch what the reliability number does not license {.densest}
...
## Milestone 6: Your data and measurement, governed {background-color="#1a1a19" .divider}
