...
| `planning/IYT_SUBMISSION_SCHEDULE.md` | The **IYT Practice (10%)** submissions (35 per student, over 40 chapters, in 20 assignments), their due dates, and the one Brightspace instruction (generated) |
...
- `iyt points = 10.0 × (sum of the highest 31 credits) / 31`.
