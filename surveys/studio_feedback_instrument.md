...
One Qualtrics survey covers all **12** Studios of the course. The student names
...
satisficing, which is precisely the failure mode of a form answered 12 times.
...
|---|---|---|---|---|
| `familiarity` | Prior topic familiarity | Before this studio's reading, how familiar were you with what these chapters cover? | Not at all familiar · Slightly familiar · Moderately familiar · Very familiar · Extremely familiar | `0–4` |
| `explain` | Perceived explainability | Right now, how well could you explain this studio's main idea to a classmate? | I could not explain it yet · I could name some parts, but not connect them · I could give a basic explanation, with some gaps · I could explain the main idea accurately · I could explain the main idea and why it matters | `1–5` |
| `effort` | Invested mental effort (Paas 1992) | How much mental effort did you invest in understanding this studio's chapters? Mental effort means how much thinking work you put in, not how many minutes it took. | 1 - Very, very low mental effort · 2 · 3 · 4 · 5 · 6 · 7 · 8 · 9 - Very, very high mental effort | `1–9` |
| `reread` | Clarity breakdown | How often did the writing make you stop and reread because the idea was not yet clear? | Never · Once · A few times · Many times · Through most of the reading | `0–4` |
| `useful` | Perceived research utility | How useful does this studio's reading seem for doing or judging research? | Not useful yet · Slightly useful · Moderately useful · Very useful · Essential · I cannot tell yet | `0–4; "cannot tell yet" is a separate code, never the midpoint` |
| `ready` | Application readiness | Without any more explanation, how ready are you to try these chapters' "It is your turn" tasks? | Not at all ready · Slightly ready · Moderately ready · Very ready · Fully ready · I did not reach those sections | `1–5; "did not reach" is a separate code, never a low score` |
...
that is far too long to repeat 12 times.
...
| Version | Item | Prompt |
|---|---|---|
| **A** | `anchor_a` | Point to one specific place in this studio's reading that helped your understanding. Name the chapter, then the sentence, example, figure, or step, and say what it helped you see. If nothing helped, name where you first got stuck and say why. |
| **B** | `anchor_b` | Point to one specific place in this studio's reading that slowed you down or blocked you. Name the chapter, then the sentence, example, figure, or step, and say what needs to change. If nothing blocked you, name the hardest place and say what made it work. |
| **C** | `anchor_c` | Choose one place in this studio's reading you would revise. Name the chapter, say where it is, and say exactly what you would change. If you would change nothing, name one place that should stay exactly as it is, and say why. |
| **D** | `anchor_d` | Write one question this studio's reading left you with, and name the chapter and the passage that prompted it. If you have no open question, write a check-for-understanding question for a classmate, and give the answer. |

Shown above all four: *"Answer in one to three sentences. Name the chapter, and be specific enough that your instructor can find the passage. Longer answers earn no more credit than short exact ones."*
...
submits 12 times), **save and continue ON**, **back button ON**, **anonymize
responses OFF**.
