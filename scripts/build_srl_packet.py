...
The draw is done, so you now know exactly which lectures are yours for the whole
semester. Have a look below, put your dates in your calendar, and then read the
rest of this so the role itself is not a mystery.
...
leads two lectures in a row, nobody leads both lectures of the same week, and
everybody leads in both halves of the semester. Nothing rotates and nothing
shifts, so these are your lectures for the term.
...
Each of your {each} leads is scored on its own, and together they make up the 25%.
