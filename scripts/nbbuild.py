...
REPORT_PLAN = (
    ...
    "lecture's topic. You are not responsible for teaching unfamiliar content: "
    "bring your current best account, name its uncertainty, and let the room "
    "test it. The report is ungraded.\n\n"
