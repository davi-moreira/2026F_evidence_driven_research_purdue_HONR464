...
- [ ] **Post the Week 1 announcements.** All three live in `_announcements/` as
...
We start **{day1}**. Before then, four things.

**1. Nothing to buy.** The course book is our own open text, *EDR|AI —
Evidence-Driven Research in the Age of AI*, free at <{SITE}/book/>. Every other
reading is free online too.

**2. Bring a laptop on day one.** All the computing runs in your browser through
Google Colab, with nothing to install. On Monday you will open the first
notebook, save your own copy, and run it, so come able to sign in to Google and
to <https://genai.rcac.purdue.edu>.

**3. Know what you are walking into.** This is a {c['credit_hours']}-credit
seminar built around one research project that is yours from the first week: you
choose the question, you defend the claim. Plan about six hours a week outside
class. The course runs on one rule — **AI is your arm and your research
assistant, not your brain** — so you will use AI constantly and you will be
graded on how well you direct and check it, never on letting it decide. And one
date belongs on your calendar now: **Tuesday, November 17**, the Purdue Fall
Undergraduate Research Expo, where you present your poster. It is required, it is
graded, and it is not a class day.

**4. Three things are already due at the end of Week 1, Sunday, August 30,
11:59 PM:** Milestone 1 (your curiosity, committed), the student profile survey,
and the Studio 1 feedback survey. You will build Milestone 1 in class on Friday,
so nothing here is a surprise — but put the date in your calendar today.

The full schedule lives at <{SITE}/schedule.html>. Read the syllabus before
Monday and bring your questions.
