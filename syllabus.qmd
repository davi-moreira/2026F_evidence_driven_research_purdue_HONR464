...
<!-- Weights come from course_config.yaml assessment: (D58, sums to 100). Keep the
...
| IYT Practice ("It is your turn" submissions) |        10% |
...
**Some activities are done without AI.** Any no-AI activity will be clearly identified in its instructions.
