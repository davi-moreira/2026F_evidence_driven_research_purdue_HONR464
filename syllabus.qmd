...
-   **AI tools:** The course teaches responsible, documented AI use (see the [AI Policy](#ai-policy)). Approved tools:
    ...
    -   **A general-purpose AI assistant of your choice** is your everyday research assistant, used in and alongside Colab. No single tool is required: pick one you can reach reliably (for example, [Google Gemini](https://gemini.google.com/){target="_blank"}), record in your AI Research Ledger which one you used, and hold it to the same verification rules whichever you choose.
...
<!-- Weights come from course_config.yaml assessment: (D58, amended by D61, D74 and D79; sums to 100).
     Keep the two in sync on every edit. D74 retired the graded Student Research Lead role and split its
     25 points 20/5 between a new Lecture Notebooks contract and the Final Project. D79 (2026-09-04)
     withdrew that split: the Lecture Notebooks category is retired too, no lecture work is collected,
     and the whole 25 points sit inside the Final Project, which rises from 55% to 75%. -->
...
<!-- RETIRED FOR THIS EDITION, KEPT FOR A FUTURE ONE (D79, 2026-09-04). D74 had replaced
     the graded Student Research Lead role with a collected Lecture Notebooks contract at
     20%. D79 withdrew that contract as well: the weekly notebook is still worked in class
     and is still the lesson, but it is not collected and not graded, and all 25 of the
     retired SRL points now sit inside the Final Project (55% to 75%). The section as it
     stood is preserved verbatim here, and the machinery behind it — the
     `lecture_notebooks:` block in course_config.yaml, the generator in
     scripts/build_participation_schedules.py and planning/LECTURE_NOTEBOOK_SCHEDULE.md —
     stays on disk, unapplied:

     ### Lecture Notebooks (20%)

     Each week you work in that week's lecture notebook during class, and you hand that
     notebook in once a week. This work is graded on completion alone: the notebook was
     worked through and submitted on time. It is never graded on whether your answers came
     out right, and nothing you say in the lab meeting is graded at all. Work that arrives a
     little late still earns partial credit, and the lowest few weeks are dropped
     automatically. The due dates and the submission instructions are posted on the course
     page.

     RETIRED FOR THIS EDITION, KEPT FOR A FUTURE ONE (D74). The graded Student Research
     Lead role was retired and replaced by two things: the ungraded ten-minute lab meeting
     that now opens each Monday and Wednesday lecture, and the Lecture Notebooks completion
     contract above. Nothing was thrown away — the SRL handbook, templates, rubric and
     scripts stay on disk under project/srl/ and scripts/, and the section as it stood is
     preserved verbatim here:

     D75 then withdrew the reporter and the slot draw as well: the ten-minute lab meeting
     stays, but nobody is assigned to it and nothing is prepared for it, and the draw script
     and the drawn roster likewise stay on disk, unapplied.

     ### Student Research Lead (25%)

     From Week 2 onward, Student Research Leads run assigned Monday or Wednesday lectures
     as Socratic investigations. Slots are randomly assigned at the beginning of the
     semester. Prepare from the SRL Lead Brief in the lecture notebook, work about one week
     ahead, and submit your filled lecture notebook by 11:59 PM the day before you lead.
     Your leading is assessed on preparation, disciplinary accuracy, facilitation of the
     investigation, inclusion of the room, and your ability to synthesize and defend the
     session's research decision.
-->
...
<!-- D74 opened the seventh documented deviation from D53's verbatim QM 47400 adoption; D79
     (2026-09-04) AMENDS that same deviation rather than adding an eighth — the deviation is still
     "the shares are not QM 47400's", only the numbers move. The list below prints COURSE percentages
     (33 / 12 / 6 / 12 / 12, summing to the Final Project's 75%), kept for continuity with what
     students were already told to read. No component was renamed and no scoring rule inside a
     component changed. The project shares (44 / 16 / 8 / 16 / 16) are the machine record in
     course_config.yaml; unlike D74's they terminate exactly. -->

The percentages below are shares of **your final course grade**, not shares of the project; together they make up the Final Project's 75%.

1.  **Milestone Deliverables (33%):** Students will submit incremental project components on specific due dates. These deliverables allow for early feedback and ensure steady progress throughout the semester. Grades will reflect each milestone's clarity, completeness, and timely submission.
2.  **Peer Evaluation (12%):** To encourage accountability and productive research work, students will evaluate their peers' contributions. These assessments help ensure balanced participation and measure collaborative effectiveness.
3.  **Peer Review (6%):** Each student will review and provide constructive feedback on the other projects' posters. This process encourages engagement, enhances critical analysis skills, and promotes a culture of constructive critique.
4.  **Poster Presentation at the Purdue Undergraduate Research Conference (12%):** A poster template and assessment rubric will be shared, and you are encouraged to review previous award-winning student posters for inspiration. Your final posters must be submitted by the due date indicated in the course schedule, after which they will be printed and distributed during a dedicated Poster Presentation Preparation class. Additional details on the conference can be found at <https://www.purdue.edu/undergrad-research/conferences/index.php>{target="_blank"}. As the event may not coincide with our regular class time, please communicate with your other course instructors in advance regarding potential scheduling conflicts. If any issues arise, please let me know. We will not hold our usual class immediately following the Poster Presentation, allowing you time to rest and catch up on other coursework. Consult the course schedule for further details.
5.  **Instructor/TA Evaluation (12%):** After the Undergraduate Research Conference your instructor will evaluate your final submission based on a rubric that will be shared.
