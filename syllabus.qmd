...
Participation is graded as one block. It covers the required course surveys, the book's "It is your turn" submissions, the course-closing reflection, and other constructive contributions to the course. These items are scored for completion and timeliness, never for the opinions they express, and the lowest few scores are dropped automatically. The full list, the due dates, and the submission instructions are posted on the course page.
