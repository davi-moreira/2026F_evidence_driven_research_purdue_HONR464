...
-   Class meetings: **Monday / Wednesday / Friday** — in person (time and room in the course syllabus). Every Monday and Wednesday lecture from Week 2 opens with a ten-minute lab meeting: one of you reports for seven minutes on a decision in your own project and the evidence behind it, then takes three minutes of questions from the room, and I lead the rest of the session.
...
<!-- Weights come from course_config.yaml assessment: (D58, amended by D61 and D74; sums to 100). Keep
     the two in sync on every edit. D74 retired the graded Student Research Lead role, replaced it with
     the Lecture Notebooks completion contract at 20%, and moved the freed 5 points into the Final
     Project (50% to 55%). -->
...
Each week you work in that week's lecture notebook during class, and you hand that notebook in once a week. This work is graded on completion alone: the notebook was worked through and submitted on time. It is never graded on whether your answers came out right, and never on how your lab-meeting report went. Work that arrives a little late still earns partial credit, and the lowest few weeks are dropped automatically. The due dates and the submission instructions are posted on the course page.
...
<!-- D74: seventh documented deviation from D53's verbatim QM 47400 adoption. The list below prints
     COURSE percentages (20 / 10 / 5 / 10 / 10, summing to the Final Project's 55%) instead of the
     adopted project shares (30 / 20 / 10 / 20 / 20), because Milestone Deliverables rose to 20 course
     points and 20/55 does not terminate. No component was renamed and no scoring rule inside a
     component changed. The exact project shares (36.37 / 18.18 / 9.09 / 18.18 / 18.18) are kept as a
     machine record in course_config.yaml. -->
