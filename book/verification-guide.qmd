---
title: "The Verification Guide"
---

*The menu of ways to confirm an AI output is true, with a note on when to reach
for each. Verification is the habit at the center of this book. Whatever method
you use, **name it in your AI Research Ledger**: "it looked right" is not a
verification.*

::: {.callout-important title="AI can review AI — but the last decision is human"}
A second model can audit the first: ask one AI to check another's claim, code,
or citation, and it will catch real errors. That counts as a check worth
running, and it never counts as the final word. An audit is another proposal,
not a verdict. The decision to accept, reject, or qualify a result always
belongs to you, the researcher.
:::
...
trust it, and the name goes in your ledger.**
...
human can pressure-test.* Walk it past a colleague, a classmate, or a mentor and
see if the reasoning survives. *Example:* you explain your identification argument
to a partner; their one question exposes an assumption you had not defended, which
goes into your limitations.
...
correlated-error trap, where one flawed idea passes its own flawed check.

## The rule, restated

1. Every AI-assisted result gets **at least one** named method before you trust
   it.
2. High-stakes results (anything that reaches your poster, paper, or public
   defense) get **two independent** methods.
3. The method's **name goes in your AI Research Ledger**. A blank or a vague word
   there is treated as no verification.
4. If you **cannot** verify an output, that is itself a finding: you do not use
   it, and you say so.

---

*Companion materials in the course repository:
[prompt design guide](https://github.com/davi-moreira/2026F_evidence_driven_research_purdue_HONR464/blob/main/ai_resources/prompt_design_guide.md){target="_blank"} (getting an output
worth checking) · [AI error taxonomy](https://github.com/davi-moreira/2026F_evidence_driven_research_purdue_HONR464/blob/main/ai_resources/ai_error_taxonomy.md){target="_blank"} (what each method
is defending against) · [AI Research Ledger template](https://github.com/davi-moreira/2026F_evidence_driven_research_purdue_HONR464/blob/main/ai_resources/ai_research_ledger_template.md){target="_blank"}
