...
| Step 3 | Before you run anything, check that every version on your list aims at the same quantity for the same units | |
| Step 4 | Run every check on your list | |
| Step 5 | Ask what every version on your list has in common | |
| Step 6 | Add one placebo: build groups you know are identical, run the same analysis on them, and confirm the gap sits near zero | |
