...
| Step 2 | Take the strongest curiosity you now hold and walk it down the funnel in writing: curiosity, topic, research problem, answerable question | |
| Step 3 | Under the question, name its three carried terms out loud: what one unit is, exactly what you would record as the outcome, and the population the… | |
...
| Step 6 | Under the question you kept, write your expected answer in one sentence, and name one real person or role for whom a different answer would be… | |
...
| Step 8 | Add it to the simple exchange log you started (the next studio's ledger inherits every line), and verify your question with a named method from the… | |
