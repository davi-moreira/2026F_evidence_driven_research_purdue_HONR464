...
| # | Criterion | 0–2 |
|---|---|---|
| Step 1 | Write your field card first: objective, unit of analysis, outcome, and the conditions or comparison that give it meaning | |
| Step 2 | Write your research problem out as questions, three or four of them, each a sentence evidence could answer and be wrong about | |
| Step 3 | Classify each question on both axes, kind and reach, and name the position | |
| Step 4 | Hunt the double-barrels | |
| Step 5 | Pick your **lead question**, the one your project will be built around | |
| Step 6 | If your lead question is causal, describe the comparison world it needs: the version of events that did not happen and that your design will have to… | |
| Step 7 | Write your provisional claim boundary: the sentence your declaration lets you hope to defend, and the stronger sentence it will not support | |
| Step 8 | Log the declaration in your AI Research Ledger, and verify it with a named method from the Verification Guide | |
| + | Craft and verification record: AI use logged in your AI Research Ledger, claims stated with their uncertainty, and each key claim verified with a named method | |
...
### Ch. 33 — Research Pitches, Talks, and Seminars
