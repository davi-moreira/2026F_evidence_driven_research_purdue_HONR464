...
You also carry forward the last milestone's artifact: **Milestone 10: Your artifact, ready to publish or present**. This one builds on it, and the chain assumes it is versioned and filed.
...
- [Lesson 37 — Open and Reusable Research Packages](https://davi-moreira.github.io/2026F_evidence_driven_research_purdue_HONR464/book/part6-after-conference/34-open-and-reusable-research-packages.html): your research capsule: notebook, data or its access recipe, environment record, README, licence with its reuse boundary and restrictions, the exact output locations, and a cold rerun in a second environment.
