...
You arrived carrying [Milestone 7: Your first reproducible analysis](milestone07-first-analysis.qmd). Milestone 9 writes down only the claims this audit licenses, at the strength it licenses them. The chain ends at [Milestone 12: Your release and next cycle](milestone12-release-next-cycle.qmd), where the versions close into your finished research artifact, released and defended.
