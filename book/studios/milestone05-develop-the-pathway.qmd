...
One bound on the skip rule here: this milestone requires your PRIMARY pathway's full piece plus ONE contrast drill from a neighboring route — the route guide says which; skipping the rest is correct. The overlay binds only when your design has stages.
