...
Due: **Sunday, August 30, 11:59 PM** (you work on it at that week's Friday
...
- **Contribution** — does answering it add something not already known? This
  ...
  arrives. M3 maps the evidence and can overturn it. Even so, any source you name
...
> This is a dated version, not a contract. M3's evidence map and M4's diagnosis
...
Close with one line recording what M1 opens in your **Research Project Dossier**:
...
days of feedback recovers up to half the lost points. In practice, most of M1's
value is that it folds directly into M2, so treat the feedback as fuel for next
week as much as points to reclaim.
...
Next: [M02 — Your Rules and Your Question](milestone_02_research_opportunity_landscape.md).
