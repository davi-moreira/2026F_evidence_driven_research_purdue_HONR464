# Course milestone M10 — Venue Contract and the Publication-Ready Artifact
...
>
> 1. **Your carry-forward record, at the very top.** Open my review email and your research action plan side by side. Answer every numbered request for this milestone (each has an ID like `IR-M10-01`) and every step your plan sets for this milestone. Next to each one, write **Done** and exactly where I can find it, or **Not adopted**, with your reason and what you chose instead. Several items can point to the same piece of work. Component 9 shows the request table and Component 10 the plan section.
...
that your M9 note does not already contain. Every number traces to a cell through
...
**preliminary** label, because it is a draft until M13.
...
to the **Poster Critic** (the required GenAI Studio reviewer role for M10; full
...
Then adjudicate, exactly as you did in your M8 audit. A flag becomes real when a
...
Every question you marked do-not-know is your agenda for M13. Write them down as
...
| **Transformation memo** | What expands, compresses, moves, becomes visual, becomes spoken, in the move from the M9 note |
...
| **Adaptation rule** | Nothing on the artifact is absent from the M9 note; the claim is no larger than the note's |
...
| **Defense rehearsal** | Five hard questions, each marked defend, concede, or do-not-know; ULN statement present; the do-not-know list carried to M13 |
...
- An element on the artifact that **does not appear in the M9 note** caps
...
- A claim on the artifact that is larger than the same claim in your M9 note:
...
1. **The artifact that outran the note.** A number, a figure, or a whole sentence
   appears on the board that is nowhere in your M9 note, usually because the
...
*Previous: [M09 — Bounded Research Note and Claim-Evidence Table](milestone_09_minimum_viable_analysis.md) ·
Next: [M13 — Reproducible Package and the Final Poster Lock](milestone_13_final_poster_lock.md) —
