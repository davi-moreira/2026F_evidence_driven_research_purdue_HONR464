...
>
> 1. **Your carry-forward record, at the very top.** Open my review email and your research action plan side by side. Answer every numbered request for this milestone (each has an ID like `IR-M08-01`) and every step your plan sets for this milestone. Next to each one, write **Done** and exactly where I can find it, or **Not adopted**, with your reason and what you chose instead. Several items can point to the same piece of work. Component 9 shows the request table and Component 10 the plan section.
...
At M7 your declared analysis became a pipeline, produced a number, and survived
...
- **A same-sign spread is a direction plus a range, never an uncertainty
  ...
  chance. Each version still carries its own sampling uncertainty from M7, and
