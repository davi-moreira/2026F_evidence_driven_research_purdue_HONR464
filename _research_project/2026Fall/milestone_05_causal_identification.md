...
the Contract version that settles the operationalization M3 left provisional.
...
Hold your M3 determination against the data as they actually arrived, not as
...
**Research Contract** (v2, if M4 issued v1), with a reason a reader could use
...
- **The provisional flag, removed.** Say plainly which M3 field stops being
...
| **Permission recheck** | The M3 determination held against the data as they actually arrived, in the form your route requires; one declared outcome |
...
| **Contract version** | The operationalization settled and issued as the next dated, numbered Contract version with a usable reason; the provisional M3 field named; measurement error stated alongside sampling uncertainty |
...
- A measurement that changed since M3 without a Contract version: *Uncertainty
...
5. **The silent swap.** Changing an indicator between M3 and this week and
