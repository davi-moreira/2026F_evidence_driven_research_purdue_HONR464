# Course milestone M17 — Release Audit and Next-Cycle Agenda
...
Milestone weights live in the syllabus; instructions and
rubrics live one page per milestone, like this one.

Your poster locked last week (M13) and now stands on its own. This milestone
builds the *voice* that stands beside it: the spoken package you carry to the
Expo floor.
...
*Previous: [M13 — Reproducible Package and the Final Poster Lock](milestone_10_final_poster_lock.md) —
the package that reproduced is the version this audit decides about · Next:
[M15 — Conference Reflection and Defense Revision](milestone_12_conference_reflection.md) —
