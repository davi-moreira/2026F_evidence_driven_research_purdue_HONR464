# Course milestone M2 — Your Rules and Your Question
...
At M1 you committed to a curiosity and chose a research problem. That problem now
...
travels with the project from this point on, and M4 turns it into a formal
...
down and carry it: it is honest, it is gradable, and M5's route hub exists
...
Close with one line recording what M2 finalizes in your **Research Project
...
1. **The silent relabel.** Your question asks what caused something, your data
   ...
   plus the missing warrant, and let M5 give it a design. Changing the question
...
*Previous: [M01 — Curiosity Committed and the Research Problem](milestone_01_research_ai_baseline.md) ·
Next: [M03 — Verified Evidence and Contribution Map](milestone_03_verified_evidence_map.md).
