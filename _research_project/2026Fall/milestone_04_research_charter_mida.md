...
>
> 1. **Your carry-forward record, at the very top.** Open my review email and your research action plan side by side. Answer every numbered request for this milestone (each has an ID like `IR-M04-01`) and every step your plan sets for this milestone. Next to each one, write **Done** and exactly where I can find it, or **Not adopted**, with your reason and what you chose instead. Several items can point to the same piece of work. Component 10 shows the request table and Component 11 the plan section.
...
- Ch. 12 — [Declaring and Diagnosing a Research Design](https://davi-moreira.github.io/2026F_evidence_driven_research_purdue_HONR464/book/part2-curiosity-to-design/10-declaring-and-diagnosing-a-research-design.html) · [companion notebook](https://colab.research.google.com/github/davi-moreira/2026F_evidence_driven_research_purdue_HONR464/blob/main/notebooks/book/ch12_declaring_and_diagnosing_a_research_design.ipynb)
...
mark it as such. You settle and version it at M6, when data and measurement get
...
- **Data strategy** — how the data come to exist: who or what gets sampled, from
  ...
  from your M3 registry**, by row, not source types. "A government price index"
...
- **Provisional operationalization, marked for revision** — how each concept
  ...
  settled at M6* written next to it. Example: "belonging = the mean of three
  survey items, provisional, settled at M6."
...
| **Provisional marking** | The operationalization carries the words *provisional, settled at M6* |
| **Data strategy sources** | Named by registry row from your M3 evidence base, not as source types |
...
*Previous: [M03 — Verified Evidence and Contribution Map](milestone_03_verified_evidence_map.md) ·
Next: [M05 — Pathway Declaration and Mandated Contrast](milestone_05_observational_descriptive_audit.md) —
