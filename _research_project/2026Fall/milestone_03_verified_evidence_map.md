...
> **Book Milestone bridge** — course milestone **M3**.
...
No question is asked in an empty room. M2 left you with a declared question and
...
M2, with its kind, its reach, and its claim boundary, and write what the verified
...
| **Revision** | Your M2 declaration explicitly revised, or held with named sources and reasons; closed by one uncertainty sentence |
...
3. **The revision that never happens.** Submitting the M2 question untouched,
...
*Previous: [M02 — Your Rules and Your Question](milestone_02_research_opportunity_landscape.md) ·
Next: [M04 — Research Contract v0 and Permission Determination](milestone_04_research_charter_mida.md) —
