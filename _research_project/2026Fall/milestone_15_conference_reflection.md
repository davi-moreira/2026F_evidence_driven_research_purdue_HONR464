...
>
> 1. **Your carry-forward record, at the very top.** Open my review email and your research action plan side by side. Answer every numbered request for this milestone (each has an ID like `IR-M15-01`) and every step your plan sets for this milestone. Next to each one, write **Done** and exactly where I can find it, or **Not adopted**, with your reason and what you chose instead. Several items can point to the same piece of work. Component 11 shows the request table and Component 12 the plan section.
...
milestone exists. It is the bridge into your research note at M16. A question that
...
you, so the fix is the poster) from a **claims signal** (a listener doubted your
evidence, so the fix may change what you are allowed to claim) from **noise** (a
reaction with no question and nothing to fix). And you refuse the most tempting
mistake in the room: reading a warm reception as proof your claims are true. A
crowd can love a poster whose central claim is wrong.

> **A question that often comes up here:** *"Most of my feedback was positive.
> Doesn't that mean my project is solid?"* It means you presented well, which is
> worth a great deal and worth almost nothing to the truth of your claim. A warm
> room is a fact about your **communication**. The rows that tell you about your
> **claims** are the skeptical questions that aimed at your evidence and kept
> coming back. Log those first, code them honestly, and let the counts, not the
> mood, write your reflection.
...
> shows why. Recalling only part of your afternoon resamples it, and a partial
> recall can quietly flip which target looks heavier. Capture in the moment; do
> not reconstruct.

### 2. The coded question tally

Every question and reaction you received at the Expo, logged as data. Build a
real table. Each row records the question and three codes:

- **Type** — what kind of question was it? One of *method*,
  *alternative-explanation*, *so-what*, *generalization*, *AI-use*, or *other*.
- **Target** — did it aim at your **claims** (whether your result is true or
  properly bounded) or your **communication** (whether a listener could follow
  you)? Tag the target where the **fix** lives, not where the sting lives.
- **Recurrence** — how many times you got a version of it. Asked once, it is an
  anecdote. Asked three times, it is a finding about your project.

**Strong row (concrete example):** *"Would this hold for transfer undergraduates?
— type: generalization; target: claims; recurrence: 3× (two faculty, one peer)."*
It is codeable, and its recurrence count means something.

**Weak row (non-example):** *"People seemed to like it."* No type, no target, no
recurrence. A page of these is applause transcription, not audience data.

### 3. The pattern you found

State, in a sentence or two read **straight off the tally**, the recurring
pattern: which **type** carried the most recurrence-weighted questions, and
whether the heavier **target** was claims or communication. Cite the rows the
pattern comes from. Then name the single **claims** question that recurred enough
to count as a finding about your project rather than a one-off. The pattern must
be readable off your own counts, not felt from the mood of the room.
...
The spine of this milestone, and the piece M16 will ask for by name. Public
...
- **The revision.** The corrected sentence, the tightened boundary, or the rebuilt
  defense you will carry into your research note at M16. Write it out in the words
...
> limitation; an unfixed weakness you hid is a defect. M16 grades the
...
- **Names the axis** it aims at — **claims** (the design cannot support the claim
  as worded) or **communication** (a reader cannot judge the result as shown).
- **Points at the evidence** on the actual poster, so anyone could check it. Not
...
Each entry must be traceable to something really on that poster. A gap you cannot
point to on the poster in front of you is one you imagined, and it does not belong
in the portfolio.

> **A question that often comes up here:** *"Isn't harsh criticism of a classmate
> unkind?"* Structured criticism is the opposite of unkind. Naming exactly where a
...
defend at M16. Any row where AI drafted a revision must record the check you ran
...
**What this rubric scores.** The book and the course together. Your book milestone's own checks are scored inside these rows: *complete and specific to your project* and *the milestone's own product* in **Feedback coding & defense revision**; *a dated, numbered version with its reason* in **Craft, ledger & communication**; *every judgment defended by you, not asserted by a tool* in **Verification of AI-assisted parts**; and *the four rails* (ethics and permissions, evidence, AI activity, uncertainty) across **Evidence integrity**, **Verification of AI-assisted parts**, **Uncertainty & limitations** and **Craft, ledger & communication**. What the course adds is your carry-forward record: the **Carry-forward** row below scores your action plan's steps, and the adjustment after the table covers the numbered review requests.
...
| Criterion | Exemplary | Proficient | Developing | Beginning |
|---|---|---|---|---|
| **Feedback coding & defense revision** (27) | Every question logged and coded consistently by type, target, and recurrence; the claims-vs-communication split is right; the pattern reads straight off the counts; every exposure carries a revision written out in full with its reason, each naming claim, boundary, or defense; any "nothing changed" is defended with the hardest question and the boundary that answered it; each portfolio entry names its axis and stays inside that poster's licensed reach; complete and unmistakably about your project (24–27) | Tally nearly complete and the split mostly right; one revision row thin, or one portfolio entry under-argued (19–23) | Partial tally, one code dimension missing throughout, a revision promised but never written out, or a criticism that names no axis (12–18) | A list of impressions rather than coded data; an undefended "nothing changed"; or reception treated as validation of the claims (0–11) |
| **Evidence integrity** (18) | Every logged question was actually asked, every revision points back to the tally rows that prompted it, every portfolio gap points at a real element on the actual poster, and the post-release note describes the package you really released (16–18) | Real and traceable throughout; one row, one poster gap, or one post-release line lightly sourced (13–15) | A question, a revision, or a poster flaw asserted without a path back to what was asked, counted, or shown (7–12) | A fabricated question you were not asked, or a poster flaw the poster does not carry (0–6) |
| **Verification of AI-assisted parts** (18) | The pattern and any shares are checked against the counts, recomputed or hand-counted rather than felt; every AI-assisted step has a ledger row with a named, non-vague verification method; every revision was decided by you, with any AI-drafted wording checked before acceptance (16–18) | Verification present; one method vague, or one AI step unlogged (13–15) | Counts used but the pattern not verified against them, or AI output accepted without a named check (7–12) | A reported count that does not rerun from the tally, or an AI-drafted reflection, revision, or critique reproduced with no verification (0–6) |
| **Uncertainty & limitations** (18) | The reflection states what remains untested and names its limits (how few questions were logged, the recall gap); each revision reason says why the evidence licenses that much and no more; the post-release note names any staleness honestly; the self-reflection check names a real weakness (16–18) | Honest reflection, revision reasons, and self-reflection; uncertainty or the warm-room caveat stated loosely (13–15) | Reflection general or performative; a revision reason that asserts rather than argues; limits gestured at but not named (7–12) | "It went great" with no substance, an overcorrection with no evidence behind it, or reception read as certainty about the claims (0–6) |
| **Craft, ledger & communication** (9) | Versioned with its reason, on-format, on-time; proof of presentation and at least three completed poster reviews attached; post-release note present; complete AI Research Ledger; dossier line present; the ethics, permissions and data-exposure rail carried as this studio requires (8–9) | Minor format lapses; ledger complete (6–7) | Missing pieces, a thin portfolio, a decorative version reason, or fewer than three poster reviews documented (4–5) | Missing AI Research Ledger (Craft scored 0, submission returned) (0–3) |
...
- A **fabricated or unretrievable source** — here, a question you were not actually
  asked, or a poster flaw the poster does not carry — caps *Evidence integrity* at
  Beginning.
- An **untraceable number** — a recurrence count with no path back to your coding
  sheet — caps *Verification of AI-assisted parts* at Beginning.
- A **non-reproducing result** — a reported pattern or claims share that does not
  match a recount of your own tally — caps *Verification of AI-assisted parts* at
  Beginning.
...
2. **The revision you promised instead of wrote.** "I should tighten my
   generalization claim" is an intention, not a revision. M16 needs the sentence
...
*Previous: [M14 — Go-Public Package](milestone_14_go_public_package.md), the
spoken editions you delivered at the Expo · Next:
[M16 — Reproducible Package and the Peer Cold Run](milestone_16_package_and_cold_run.md) —
the criticism discipline you just turned on your own reception becomes the
standard a colleague applies to your package, live, in the room.*
