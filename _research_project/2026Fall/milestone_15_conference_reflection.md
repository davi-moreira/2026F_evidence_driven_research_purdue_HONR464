...
*Carry-forward row:* a plan step that is also a numbered request (`IR-M15-##`) is scored once, through the carry-forward adjustment below, not in this row. The plan that counts is the latest version I sent you before the deadline.
