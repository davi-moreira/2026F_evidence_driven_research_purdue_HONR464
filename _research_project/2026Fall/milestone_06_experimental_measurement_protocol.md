...
| **Evidence integrity & provenance** (20) | Data loaded from the documented M5 source; the environment is recorded; every reported number traces to a data cell and a line of code (18–20) | Traceable; one trace row or the environment record thin (14–17) | A dataset or number asserted without a locatable origin, or an incomplete trace (8–13) | A source that does not exist, or a number with no path back to data (0–7) |
...
Next: [M07 — Robustness Audit](milestone_07_declared_analysis_protocol.md) —
