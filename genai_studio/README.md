...
- **Groups.** A group shares custom models and knowledge bases with a set of
  Purdue users. The course runs one group for its four students.
...
## The five required milestone touchpoints

Most role use is optional support. At five milestones, consulting a specific
