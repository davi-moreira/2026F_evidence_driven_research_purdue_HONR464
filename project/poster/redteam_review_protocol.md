...
**2. Figure-honesty audit.**
- ☐ Axes start where the data honestly start (no truncation that inflates a difference)?
- ☐ Bins, scales, and aspect ratio chosen to inform, not to impress?
- ☐ Does every figure show its uncertainty or carry its caveat?
- ☐ Does the visual impression match the number? (The impression is itself a claim.)

**3. Read-path audit.**
- ☐ Is the entry point obvious within 3 seconds?
- ☐ Does the eye reach the headline claim before the methods?
- ☐ Any dead end, backtrack, or box that competes with the top-center slot?
- ☐ Could you retell the argument after 90 seconds of reading?

**4. Uncertainty audit.**
- ☐ Is the uncertainty line visible without leaning in?
